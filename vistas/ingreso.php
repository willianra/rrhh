                  ...
                  <div class="box">
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                            <!-- <label>Número:</label> -->
                           <!--  <input type="hidden " class="form-control" name="num_comprobante" id="num_comprobante" maxlength="10" placeholder="Número" required="">
                        -->   </div>
                          <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a data-toggle="modal" href="#myModal">           
                              <button id="btnAgregarArt" type="button" class="btn btn-primary"> <span class="fa fa-plus"></span> Agregar Pedido</button>
                            </a>
                          </div>
