...
<!-- prueba -->
        <div style="padding: 14px 34px">
           <div style="border: #e26b09 1px solid; background-color: #e26b09">
              <div style="font-family: 'Comic Sans MS'">
                  <h1 style="font-size: 35px;color: #f8fffd">
                  Te damos la bienvenida a nuestra pagina para poder dar a conocer tu producto al mundo inicia con tu registro                  
                  </h1>
              </div>
            </div>
        </div>
<!-- fin -->
                      <!-- 
                        <div style = 'text-align: center'>  
                          <h1 class="box-title">Te damos la bienvenida a nuestra pagina para poder dar a conocer tu producto al mundo inicia con tu registro</h1>
                        </div>       
                        -->
                            
                        <div style = 'text-align: center'>
                          <img src="../public/images/titulo.jpeg" width="800" height="300" >
                        </div>
                      <!-- 
                        <div style = 'text-align: center'>
                          <h1 class="box-title">REGISTRATE AQUI !!!</h1>
                        </div>
                       -->

                        <!-- prueba -->
                      <div style="padding: 14px 34px">
                        <div style="border: #4c65ef 1px solid; background-color: #4c65ef">
                          <div style="font-family: 'Comic Sans MS'">
                             <h1 style="font-size: 35px;color: #f8fffd">
                             <div style = 'text-align: center'>
                          <h1 class="box-title">REGISTRATE AQUI !!!</h1>
                   ...
                   <!-- fin -->
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <!-- <label>Cargo:</label> -->
                            <!-- <input type="hiden" class="form-control" name="cargo" id="cargo" maxlength="20" placeholder="Cargo"> -->
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Login (*):</label>
